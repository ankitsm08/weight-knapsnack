...
form.addEventListener("submit", async (e) => {
  ...
  if (data.error) {
    ...
    let comboRows = Object.entries(data.combo).map(
      ([weight, count]) =>
    ...
    comboRows.push(
      `<tr style="font-size: 1.1rem; font-weight: bold;"><td>All Total</td><td>${
        data.bottles_used
...
<div class="result-cards">
    ...
    <div class="card result-card">
        ...
        ${
          Math.round((data.total_weight_kg - data.target_weight_kg) * 1000) ===
          0
            ? "(=)"
